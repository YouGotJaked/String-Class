...
//     Postcondition: Returns the first occurrence of a specified character.
//
//   unsigned int count(char c) const;
//     Postcondition: Counts the number of occurrences of a specified character
...
//     Precondition: The source and destination are not the same string. 
//     Postcondition: The string is now the source string.
//
//   void insert(const string& source, unsigned int position)
//     Precondition: position <= length( )
//     Postcondition: Inserts a string at a given position in another string.
//
//   void replace(char c, unsigned int position);
//     Postcondition: Replaces a single character in a string with a new character.
//
